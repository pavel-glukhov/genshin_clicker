...
from src.config import load_config, get_chrome_config
...
class ParserClient:
    ...
    def _driver_init(self) -> webdriver.Chrome:
        ...
        options, cdp_script = get_chrome_config(headless=True)
        driver = webdriver.Chrome(options=options)
        driver.implicitly_wait(15)
        driver.execute_cdp_cmd("Page.addScriptToEvaluateOnNewDocument", {"source": cdp_script})
